...
interface ResetTarget : GitCommandOptions {
    ...
    /** The Git ID of the commit or other version-history entity to reset to. */
    fun ref(): String

    /**
     * Whether a `--hard` reset should be performed.
     *
     * Hard resets don't stage the changes for commit and simply modify the files back to the
     * state at [ref].
     */
    fun isHard(): Boolean
}
